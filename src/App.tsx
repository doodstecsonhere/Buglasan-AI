  ...
  return <div className="app-shell flex min-h-[100dvh] flex-col overflow-hidden text-slate-900">
    ...
    <div className="mx-auto flex min-h-0 w-full flex-1 max-w-[1440px]">
      ...
      <main className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        <header className="app-header"><div className="mx-auto flex w-full max-w-4xl items-center justify-between gap-3"><div className="flex min-w-0 items-center gap-3"><button onClick={() => setHistoryOpen(true)} className="icon-button md:hidden" aria-label="Open chat history">☰</button><div className="min-w-0"><p className="brand-name">BUGLASAN AI (DEMO)</p><h1 className="truncate text-base font-bold sm:text-lg">Your Festival Guide</h1></div></div>{installPrompt && !installDismissed && !isStandalone && <button type="button" className="install-button" onClick={installApp}>Install App</button>}</div></header>
