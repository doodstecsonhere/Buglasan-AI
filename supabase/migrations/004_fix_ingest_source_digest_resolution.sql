-- Forward fix: schema-qualify hosted pgcrypto digest while retaining the hardened RPC search path.
-- Migration 003 is already deployed and intentionally remains immutable.
