// Shared schedule data — duplicated from src/data/schedule2026.ts for the edge function.
// The edge function runs in Deno and cannot import from the Vite src tree.
