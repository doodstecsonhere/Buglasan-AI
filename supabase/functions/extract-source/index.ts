...
const ACCEPTANCE_FIXTURES: Readonly<Record<string, { source: string; result: ExtractionResult }>> = {
  ...
  'reconciliation-test-03-similar': { source: 'Buglasan Lantern Festival Parade 2027 is confirmed on October 20, 2027 at 6:00 PM at Riverside Park.', result: { candidates: [fixtureCandidate({ event_name: 'Buglasan Lantern Festival Parade 2027', category: 'parade', start_datetime: '2027-10-20T18:00:00+08:00', venue: 'Riverside Park', status: 'confirmed', festival_year: 2027, evidence: [{ field: 'event_name', excerpt: 'Buglasan Lantern Festival Parade 2027' }, { field: 'category', excerpt: 'Parade' }, { field: 'start_datetime', excerpt: 'October 20, 2027 at 6:00 PM' }, { field: 'venue', excerpt: 'Riverside Park' }, { field: 'status', excerpt: 'confirmed' }, { field: 'festival_year', excerpt: '2027' }] })], source_summary: null } },
  'reconciliation-test-04-unknown': { source: 'Buglasan Lantern Parade 2027 is planned at Freedom Park.', result: { candidates: [fixtureCandidate({ event_name: 'Buglasan Lantern Parade 2027', venue: 'Freedom Park', festival_year: 2027, evidence: [{ field: 'event_name', excerpt: 'Buglasan Lantern Parade 2027' }, { field: 'venue', excerpt: 'Freedom Park' }, { field: 'festival_year', excerpt: '2027' }], review_reasons: ['ambiguous_date'] })], source_summary: null } },
  'reconciliation-test-05-no-event': { source: 'Thank you for supporting Buglasan 2027.', result: { candidates: [], source_summary: null } },
  'reconciliation-test-06-newest': { source: 'Buglasan Lantern Parade 2027 is confirmed on October 18, 2027 at 7:00 PM at Freedom Park.', result: { candidates: [fixtureCandidate({ event_name: 'Buglasan Lantern Parade 2027', category: 'parade', start_datetime: '2027-10-18T19:00:00+08:00', venue: 'Freedom Park', status: 'confirmed', festival_year: 2027, evidence: [{ field: 'event_name', excerpt: 'Buglasan Lantern Parade 2027' }, { field: 'category', excerpt: 'Parade' }, { field: 'start_datetime', excerpt: 'October 18, 2027 at 7:00 PM' }, { field: 'venue', excerpt: 'Freedom Park' }, { field: 'status', excerpt: 'confirmed' }, { field: 'festival_year', excerpt: '2027' }] })], source_summary: null } },
