...
const ACCEPTANCE_FIXTURES: Readonly<Record<string, { source: string; result: ExtractionResult }>> = {
  ...
  'subject-scope-test-buglas-camp-fest': { source: 'Buglas Camp Fest 2026 is confirmed on October 18, 2026 at 6:00 PM at Dons Magna, Dauin, Negros Oriental. #BuglasCampFest2026 #CampFest', result: { candidates: [fixtureCandidate({ event_name: 'Buglas Camp Fest 2026', category: 'competition', start_datetime: '2026-10-18T18:00:00+08:00', venue: 'Dons Magna, Dauin, Negros Oriental', status: 'confirmed', festival_year: 2026, evidence: [{ field: 'event_name', excerpt: 'Buglas Camp Fest 2026' }, { field: 'category', excerpt: 'CampFest' }, { field: 'start_datetime', excerpt: 'October 18, 2026 at 6:00 PM' }, { field: 'venue', excerpt: 'Dons Magna, Dauin, Negros Oriental' }, { field: 'status', excerpt: 'confirmed' }, { field: 'festival_year', excerpt: '2026' }] })], source_summary: null } },
